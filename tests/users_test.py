...
# Se crea FastAPI Test _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _
...
Test_users = {                                          # Diccionario que simula usuarios
    1: {
        "id": 1,
        "name": "Juan",
        "favoritas": []
...
Test_movies = {                                         # Diccionario que simula películas
    10: {
        "id": 10,
        "title": "Matrix"
    }
...
def test_get(lista, item_id=None):                      # función get del repositorio
    if lista == "users":                                # Si se pide la lista users
        return test_users.get(item_id)                  # Devuelve el usuario si existe
    if lista == "movies":                               # Si se pide la lista movies
        return test_movies.get(item_id)                 # Devuelve la película si existe
    return None                                         # Si no existe, devolvemos None


def test_update(lista, item_id, data):                  # Simula la función update del repositorio
    if lista == "users":                                # Si se actualiza un usuario
        test_users[item_id] = data                      # Guardamos los cambios en el diccionario


# TEST: Agregar película a favoritas correctamente _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _

def test_add_favorite_movie(monkeypatch):                     # Test para agregar película a favoritas
    monkeypatch.setattr("routers.users.get", test_get)        # Reemplaza get por test_get
    monkeypatch.setattr("routers.users.update", test_update)  # Reemplaza update por test_update
    ...
    assert 10 in test_users[1]["favoritas"]                   # Verifica que la película esté en favoritas

# TEST: Usuario no existe _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _

def test_add_favorite_user_not_found(monkeypatch):      # Test cuando el usuario no existe
    monkeypatch.setattr("routers.users.get", fake_get)  # Reemplaza get por test get
...
# TEST: Película no existe _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _
...
# TEST: Película ya está en favoritas _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _


def test_add_favorite_already_exists(monkeypatch):      # Test cuando la película ya está en favoritas
    test_users[1]["favoritas"] = [10]                   # Agregamos la película previamente

    monkeypatch.setattr("routers.users.get", test_get)  # Reemplazamos get por test_get
...
# TEST: Eliminar película de favoritas _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _


def test_remove_favorite_movie(monkeypatch):            # Test para eliminar película de favoritas
    test_users[1]["favoritas"] = [10]                   # Dejamos la película en favoritas
    ...
    assert 10 not in fake_users[1]["favoritas"]         # Verifica que se eliminó
...
def test_get_favorite_movies(monkeypatch):              # Test para listar películas favoritas
    fake_users[1]["favoritas"] = [10]                   # Dejamos una película en favoritas

    monkeypatch.setattr("routers.users.get", fake_get)  # Reemplaza get por test_get

    response = client.get("/users/1/favorites")         # Hace la petición GET

    assert response.status_code == 200                  # Verificamos el status 200
    assert response.json() == [test_movies[10]]         # Verificamos la lista de películas
